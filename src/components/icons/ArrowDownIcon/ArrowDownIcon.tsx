...
const ArrowDownIcon: React.FC<IconProps> = ({className, color, width, height}) => {
    ...
    return <Icon color={color} width={width ? width : 24} height={height ? height: 24} className = {classes}>
